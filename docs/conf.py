...
# import os
# import sys
# sys.path.insert(0, u'/Users/simsdj/Dropbox/pyprojects/matchbox_dev/src/matchbox_api_utils/matchbox_api_utils')
...
latex_documents = [
    (master_doc, 'matchbox_api_utils.tex', u'matchbox\\_api\\_utils Documentation',
     u'Author', 'manual'),
]
